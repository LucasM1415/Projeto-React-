    ...
    return(
      ...
      <div class="box">
            <div class="pharse-div">
              ...
              <div class="pharse-div">
                <p>"Não são as nossas ideias que nos fazem otimistas ou pessimistas, mas o otimismo e o pessimismo de origem fisiológica que fazem as nossas ideias."</p>
              </div>
              <div class="pharse-div">
                <p>"O remorso é a única dor da alma, que nem a reflexão nem o tempo atenuam."</p>
              </div>
              <div class="pharse-div">
              ...
              <div class="pharse-div">
                <p>"Só existem dois dias no ano que nada pode ser feito. Um se chama ontem e o outro se chama amanhã, portanto hoje é o dia certo para amar, acreditar, fazer e principalmente viver."</p>
              </div>
              <div class="pharse-div">
                <p>"A pessoa inteligente estuda a vida inteira para descobrir que não tem nada melhor do que dar uma de burro"</p>
              </div>
        </div>
